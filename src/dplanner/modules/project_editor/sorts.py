...
The gaps are chosen so the default node reproduces the old rhythm: ``NODE_W + H_GAP`` is the
260-point column pitch the canvas has always had, ``NODE_H + V_GAP`` the 110-point row.
