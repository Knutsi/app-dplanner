"""The docs aspect: what a step contributes to the product's documentation.
...
package's Qt-free files unreachable without loading Qt, and the CLI reaches them through
this package.
"""
